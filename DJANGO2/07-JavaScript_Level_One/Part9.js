...
var split_fn = firstName.split("");
var split_ln = lastName.split("");
var split_pet = pet.split("");



if(split_fn[0] === split_ln[0] && age > 20 && age < 30  && height >= 170 ){
for(var i=0; i<split_pet.length; i++){
  if( split_pet[i] === "y" )
    console.log("you're the spy");
}
}else {
